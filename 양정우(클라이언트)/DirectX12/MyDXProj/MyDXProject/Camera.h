...
#define FIRST_PERSON_CAMERA		0x01	// 1인칭
#define SPACESHIP_CAMERA		0x02	// 비행기
#define THIRD_PERSON_CAMERA		0x03	// 3인칭
...
// Generate Matrix
	...
	void GenerateViewMatrix(XMFLOAT3 xmf3Position, XMFLOAT3 xmf3LookAt, XMFLOAT3 xmf3Up);									// World -> Camera
	void GenerateProjectionMatrix(float fNearPlaneDistance, float fFarPlaneDistance, float fAspectRatio, float fFOVAngle);	// Camera -> Projection(투영)
